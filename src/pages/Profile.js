...
const Profile = ({ cart }) => {
  const subscribe = async () => {
    const key =
      "BB3c4l3d7l4-lUyRbY8ztRYl1iwEC-IjNTdjX9-0nZ2PdtimzCFbGZmq8orTBTtBiJQ-W9F3boDAY--l89de6jA";
    ...
    try {
      ...
      console.error("Cannot subcribe.", err.message);
    }
  };
              ...
              <ul className="items-center flex">
                ...
                <li className="ml-6">
                  <Link
                    id="header-cart"
                    to="/cart"
                    className="flex items-center justify-center w-8 h-8 text-black cart"
                  >
                    <svg
                      className="fill-current"
                      width="29"
        ...
        <div className="container mx-auto min-h-screen">
          <div className="flex flex-col items-center justify-center">
            <div className="w-full md:w-4/12 text-center">
              ...
              <h2 className="text-xl font-semibold mb-1">Ada Lovelace</h2>
              <p className="text-lg mb-12">Sr. Front-End Developer</p>
            </div>
          </div>
